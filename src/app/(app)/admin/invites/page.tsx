...
export default async function AdminInvitesPage() {
  ...
  return (
    <div className="overflow-auto px-4 pt-4 pb-8 sm:px-6 sm:pt-5">
      <div className="mb-4"><Hint>Each link lasts as long as you chose when you made it. {emailOn ? "New invites are emailed straight away, and you can send one again from the row." : "Nothing is emailed until you pick a provider on the Email tab; copy the link and send it yourself."}</Hint></div>
      {invites.length === 0 ? (
